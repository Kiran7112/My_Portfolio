...
import { SiFirebase, SiPostman, SiKubernetes, SiAnsible, SiTerraform, SiJenkins, SiNetlify, SiTensorflow, SiRedux } from 'react-icons/si';
...
const skills = {
  frontend: {
    ...
    skills: [
      ...
      { name: 'Vite', icon: <FaBootstrap color="#61DAFB" /> }, // Replace with a custom icon or use a different icon
      { name: 'JavaScript', icon: <FaJs color="#F7DF1E" /> },
      { name: 'ReactJS', icon: <FaReact color="#61DAFB" /> },
      { name: 'Redux', icon: <SiRedux color="#764ABC" /> }, // Corrected color
      { name: 'Bootstrap', icon: <FaBootstrap color="#7952B3" /> }, // Corrected color
    ],
  },
  backend: {
    title: 'Backend',
  ...
  other: {
    ...
    skills: [
      ...
      { name: 'VS Code', icon: <VscVscode color="#007ACC" /> }, // Corrected icon
